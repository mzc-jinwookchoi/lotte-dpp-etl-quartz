...
public class EtlBatchClass implements Job{
    static final String redshiftDriverPRD = "jdbc:redshift://ddm-dev-dw-rs.cgtezcyc68ol.ap-northeast-2.redshift.amazonaws.com:45439/ldddmp";
//    static final String redshiftDB = "ldddmp";
    ...
    public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        ...
        try{
            ...
            conn = DriverManager.getConnection(redshiftDriverPRD, props);
